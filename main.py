...
from faction_system.faction_manager import GameFactionManager
...
class Game:
    ...
    def __init__(self):
        ...
        self.faction_manager = GameFactionManager(self.event_bus)
        ...
        self.state_manager.set_persistent_data("faction_manager", self.faction_manager)
    ...
    def update(self, dt):
        ...
        self.faction_manager.update(pygame.time.get_ticks())
